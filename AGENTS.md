...
- PR を作成した場合は、`/goal` コマンドで CI 結果と GitHub Copilot レビューの完了を確認する。
- CI または GitHub Copilot レビューに指摘がある場合は対応し、再度結果を確認する。
- すべての必須 CI と GitHub Copilot レビューの結果が想定どおりであることを確認してから完了扱いにする。
